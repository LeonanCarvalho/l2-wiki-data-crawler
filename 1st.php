...
const OUTPUTDIR = 'out'.DIRECTORY_SEPARATOR.'1stJob'.DIRECTORY_SEPARATOR;
            ...
            $quest->filter('#mw-content-text > div > ol > li')
                ->each(function(Crawler $li, $index) use(&$meta){
                    ...
                    */
                    ...
                    $location->clear();//Remove map linkW
